...
Chart.defaults.financial = {
	...
	tooltips: {
		...
		callbacks: {
			source: 'labels',
			title: function(tooltipItem, data, a) {
			...
			footer: function(tooltipItems, data) {
				var currency = sharesChart.currency;
				var tooltipItem = tooltipItems[0].index;
				var o = data.datasets[0].data[tooltipItem].o;
				var h = data.datasets[0].data[tooltipItem].h;
				var l = data.datasets[0].data[tooltipItem].l;
				var c = data.datasets[0].data[tooltipItem].c;
				var dataset = data.datasets[0];
				var precision = helpers$1.valueOrDefault(dataset.precision, 2);
				precision = Math.max(0, Math.min(100, precision));
				o = o.toFixed(precision) + ' ' + currency;
				h = h.toFixed(precision) + ' ' + currency;
				l = l.toFixed(precision) + ' ' + currency;
				c = c.toFixed(precision) + ' ' + currency;
...
console.log(globalOpts$1.elements.financial.color.unchanged);
